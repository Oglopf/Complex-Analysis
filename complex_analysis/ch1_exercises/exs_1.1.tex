...
\begin{enumerate}
	...
	\item Let $\alpha$ be a complex number $\neq 0.$ What is the absolute value
	      ...
	      \begin{align*}
		      ...
		      \therefore \; \left| \frac{\alpha}{\bar{\alpha}} \right|
		                            & = \frac{\alpha \cdot \bar{\alpha}}{ \left | \bar{\alpha} \right |^2  } \\
	      \end{align*}
	      \qed
	      ...
	      So now because the conjugate operation just changes the sign on the \textit{imaginary} part of $\alpha$ we have
	      the straightforward result of:
	      \begin{align*}
	...
	\item Prove that for any two complex numbers $z, w$ we have:
	      \begin{enumerate}
		      ...
		      \item $|z| - |w| \leq |z - w|$
		            ...
		            \textbf{Proof:}
		            By (a) above we just subtract $|w|$ off the right and left, and have a logically
	...
	\item Let $\alpha = a +ib$ and $z = x +iy.$ Let $c \in \mathbb{R} > 0.$ Transform the condition:
	      $$|z - \alpha| = c$$
	      into an equation involving only $x, y, a, b$ and $c$, and describe in a simple way what geometric figure is
