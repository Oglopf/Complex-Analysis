...
\begin{defn}[\textbf{Factors of Pi}]
	...
	\begin{align*}
		...
		e^{i\pi} &= -1 + i0 = (-1, 0) \\ 
		e^{2i\pi} &= 1 + i0 = (1, 0) \\ 
		e^{\sfrac{i\pi}{2}} &= 0 +  i  = (0, 1) \\
		e^{\sfrac{i\pi}{3}} &= \frac{1}{2} + i\frac{\sqrt{3}}{2} = \left(\frac{1}{2}, \frac{\sqrt{3}}{2} \right) \\
		e^{\sfrac{i\pi}{4}} &= \frac{\sqrt{2}}{2} + i\frac{\sqrt{2}}{2} = \left( \frac{\sqrt{2}}{2}, \frac{\sqrt{2}}{2} \right) \\
		e^{\sfrac{i\pi}{6}} &= \frac{\sqrt{3}}{2} + i\frac{1}{2} = \left( \frac{\sqrt{3}}{2}, \frac{1}{2} \right)  \\
...
Let $f$ be a function on $S,$ and let $\alpha$ be an adherent point of $S.$ Let $w$ be a complex number. We say that:
	\[ z \in S \]
	\[ w = \lim_{z \to \alpha} f(z) \]
...
This section is a bit peculiar and wasn't all that useful. I'll circle back around later for this.

\subsection{Proofs}
\begin{enumerate}
	\item Let $\alpha$ be a complex number of absolute value $< 1.$ What is $\lim_{n \to \infty} \alpha^n ?$ Proof? \\

	\textbf{Proof:} \\
	\\
	Think about the expansion

	\item If $|\alpha| > 1$ does $\lim_{n \to \infty} \alpha^n$ exist? Why?
\end{enumerate}
