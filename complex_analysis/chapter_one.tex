...
\begin{enumerate}
	...
	the whole sequence converges if its absolute value converges.
	...
	then clearly $z^m < z^n$ and so this sequence is monotonic, it only decreases each new term.

	Therefore let $\epsilon > 0$ and see by definition:
	\begin{align*}
		|\alpha - 0| < \epsilon^n \\
